...
(
	...
	[Pays] INT FOREIGN KEY REFERENCES [Pays]([Id]) ON DELETE CASCADE
)
...
-- 	CONSTRAINT chk_valeur_sexe CHECK (Sexe 'FEMME' OR Sexe LIKE 'HOMME')
-- )
...
(
	...
	CONSTRAINT fk_perso_img FOREIGN KEY(Id_img_principale) REFERENCES Image(Id) ON DELETE CASCADE,
	...
	-- CONSTRAINT fk_perso_sexe FOREIGN KEY(Id_sexe) REFERENCES Sexe(Id) ON DELETE CASCADE
)
...
-- 	CONSTRAINT fk_arb_pers_arbre FOREIGN KEY(Id_arbre) REFERENCES Arbre(Id) ON DELETE CASCADE,
-- 	CONSTRAINT fk_arb_pers_personne FOREIGN KEY(Id_personne) REFERENCES Personne(Id) ON DELETE CASCADE
-- )
